...
def get_app_path():
    for file in os.listdir('./_artifacts/Global'):
...
print("BI-App-Android-Global-"+build_version+"-SmokeTest")

config = {
    
    # This is the app under test.
     "appFilePath":"./_artifacts/Global/"+app_build_path,
     
    # Project Arn
    "projectArn":"arn:aws:devicefarm:us-west-2:138464956925:project:58974e4d-91a5-48c3-a18f-a41c45e1a496",
    
    # Pool Arn (Google Pixel 3 XL)
    #"poolArn": "arn:aws:devicefarm:us-west-2:138464956925:devicepool:58974e4d-91a5-48c3-a18f-a41c45e1a496/1279de36-0022-435c-be8a-217314a8cd62",
    
    # Android smoke test Pool arn (Galaxy A14 + Galaxy Tab A 8 )
    # "poolArn": "arn:aws:devicefarm:us-west-2:138464956925:devicepool:58974e4d-91a5-48c3-a18f-a41c45e1a496/507a742c-0f8f-4dc5-8c9e-4c6bfbe57423",
    # Android smoke test Pool arn (Galaxy s22 + Galaxy Tab A 10.1 )
    "poolArn": "arn:aws:devicefarm:us-west-2:138464956925:devicepool:58974e4d-91a5-48c3-a18f-a41c45e1a496/df1733d9-ad95-4d5e-883e-e90ff1fdaca7",
    ...
    "namePrefix": "BI-App-Android-Global-"+build_version+"-SmokeTest",
    
    # Test Package including the Dev Smoke Tests suite. This should be updated only when tests suite is changed.  
    #"testPackage": "AWSTester_SmokeTests.zip", active 88ec97ab00f8
    # Test Package Arn (short test) This is the test package arn - for now, it's NOT needed to re- upload
    #"testPackageArn": "arn:aws:devicefarm:us-west-2:138464956925:upload:58974e4d-91a5-48c3-a18f-a41c45e1a496/203c54aa-7c0d-4eeb-ad73-bbe41bdda194"
    ...
    #"testPackage": "./TestArchive/AWSTester_ShortTest1.zip"
    #"testPackageArn": "arn:aws:devicefarm:us-west-2:138464956925:upload:58974e4d-91a5-48c3-a18f-a41c45e1a496/e0fffb82-5307-47d6-9bf1-3368e4e37483"
...
for job in jobs_response['jobs'] :
    ...
    if (os.path.isfile(resultspath) and os.path.getsize(resultspath) > 0):
        ...
        testmorun.do_upload_testresult_testmo(test_results_xml_path,job_name,batch_name,TestmoKey,"smoketest-global")
    else:
        ...
        testmorun.do_upload_testresult_testmo(xml_report_error_path,job_name,batch_name,TestmoKey,"smoketest-global") 
